...
{
    public class LocalElement2P : ILocalElement
    {
        /// <summary>
        /// Array[4] of KSI values at each integration point
        /// </summary>
        double[] Ksi = { -1 * 1/Math.Sqrt(3), 1 / Math.Sqrt(3), 1 / Math.Sqrt(3), -1 * 1 / Math.Sqrt(3) };
        /// <summary>
        /// Array[4] of ETA values at each integration point
        /// </summary>
        double[] Eta = { -1* 1 / Math.Sqrt(3), -1* 1 / Math.Sqrt(3), 1 / Math.Sqrt(3), 1 / Math.Sqrt(3) };
        ...
        double[] Y ;
        /// <summary>
        /// [4x4] matrix containig [dX/dKSI,dY/dKSI][dX/dETA,dY/dETA]
        /// </summary>
        ...
        public LocalElement2P(double[] x , double[] y )
        {
        ...
        public LocalElement2P(Grid grid,Element element)
        {
            this.DerivativesOfShapeFunctions = new double[2, 4, 4];
            this.X = new double[4];
            this.Y = new double[4];
